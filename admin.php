...
<div class="trial">
    ...
    <div style="float:right; text-align:right; padding-right:15px; padding-top: 20px;">
      <form action="" method="post" id="login_form">
      	<!-- if logged in then hide login button and show logout and vice-versa -->
        ...
        <?php } else { ?>
            ...
            <a class="button button_orange" href="register.php">Sign Up</a>
        <?php }?>
      </form>
     </div> 
</div>
  
<div class="news_update"><span class="heading">User Management</span>
	  <!-- if user has posted email and login hidden value then try doLogin -->
	  <?php
...
<fieldset><legend></legend>         
    ...
    width:800px;">
    <!-- try show user management, the Admin class if logged in user is admin  -->
  	<?php
  		require_once 'php/adminclass.php';
		$admin = new Admin($dbHost, $dbName, $dbUser, $dbPass);
		$admin->showTable();
	?>
   </div>
   <div id="result">...</div>
