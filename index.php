...
<div class="news_update"><span class="heading">Probed Devices (last 5min)</span>
	  <?php
...
<fieldset><legend></legend>         
    ...
    width:800px;">
  	<?php
  		require_once 'php/probedclass.php' ;
		$probed_devices = new ProbedDevice($dbHost, $dbName, $dbUser, $dbPass, 300);
		// $probed_devices->setProbedSince(999999);
		$probed_devices->showTable();
	?>
   </div>
   <div id="result">...</div>
</fieldset>
